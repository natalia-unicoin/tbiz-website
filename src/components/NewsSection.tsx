...
const NewsSection = () => {
    ...
    return (
        <section style={{ position: 'relative', backgroundColor: '#F9FAFB', paddingBottom: '120px', paddingTop: '120px', borderTop: '1px solid #E5E7EB', overflow: 'hidden' }}>
            {/* Background Image */}
            <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url("/assets/news-bg-v3.png")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', zIndex: 0 }}></div>
                    ...
                    {categories.map(cat => (
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '30px',
                                border: 'none',
                                backgroundColor: activeFilter === cat ? '#111827' : 'rgba(243, 244, 246, 0.8)',
